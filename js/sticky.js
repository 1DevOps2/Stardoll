...
(function( $ )
	...
	$.fn.sticky = function(note, options, callback) 
		...
		var uniqID = Math.floor(Math.random()*999);
		...
		$('.sticky-note').each(function()
			...
			if($(this).attr('id')==uniqID)
				{ uniqID = Math.floor(Math.random()*999); }
			});
	...
	var Platforms =["<span class='platfrom-append'>on</span> PC","<span class='platfrom-append'>on</span> Mobile","<span class='platfrom-append'>on</span> iOS","<span class='platfrom-append'>on</span> iOS","<span class='platfrom-append'>on</span> Android"];	
	var FUTresources =["<span class='activity-futcoins'>1.Stardollars</span><span class='activity-futpoints'>50  Starcoins</span>","<span class='activity-futcoins'>800 Stardollars</span><span class='activity-futpoints'>40 Starcoins</span>","<span class='activity-futcoins'> Stardollars </span><span class='activity-futpoints'>30 Starcoins</span>","<span class='activity-futcoins'> Stardollars </span><span class='activity-futpoints'>10 Starcoins</span>","<span class='activity-futcoins'>800 Stardollars </span><span class='activity-futpoints'>20 Starcoins</span>", "<span class='activity-futcoins'>600 Stardollars </span><span class='activity-futpoints'>30 Starcoins</span>", "<span class='activity-futcoins'>800 Stardollars </span><span class='activity-futpoints'>50 Starcoins</span>", "<span class='activity-futcoins'>400 Stardollars</span><span class='activity-futpoints'>50 Starcoins</span>"];	
