$(document).ready(function() {
  $("a[rel*=leanModal]").leanModal();
	...
	var sliderCurrentValue = $( "#slider-futcoins" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue + 200 );
	});
	...
	$('#increase-futpoints').click(function() {
		...
		sliderPoints.slider( "value", sliderCurrentPointsValue + 100 );
	});
	...
	$('#first-step-button').click(function () {
		$('#instructions-success-confirmation-step-1').addClass('completed').html( "Completed" );
	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				$('#instructions-success-confirmation-step-3').html( "Processing" );
				...
				setTimeout(function() {
					$console_message.html("Generating Packets for Stardollars");
					progressBarConsole(38, $('#progressBarConsole'));
				}, 11000 );
				setTimeout(function() {
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_futcoins_msg + "</span> Stardollars");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_futcoins_msg + "</span> <span class='console-message-success'>Stardollars Coins Generated Successfully</span>");
				...
				setTimeout(function() {
					$console_message.html("Generating Packets for Starcoins");
					progressBarConsole(58, $('#progressBarConsole'));
				}, 18000 );
				setTimeout(function() {
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_futpoints_msg + "</span> Starcoins");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_futpoints_msg + "</span> <span class='console-message-success'>Starcoin Generated Successfully</span>");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-error'>Verification Failed</span>");
					progressBarConsole(93, $('#progressBarConsole'));
				}, 30000 );
				setTimeout(function() {
				...
				setTimeout(function() {
					...
					$('#instructions-success-confirmation-step-3').addClass('waiting-for-verification').html( "Waiting for Verification" );
					if ($(window).width() < 600) {
	...
	$('#second-step-button').click(function() {
		if ($('#account-username').val() != '') {
			$('#instructions-success-confirmation-step-2').addClass('completed').html( "Completed" );
			loading_step()
		}
		else {
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit Stardoll coins generator out there');
                        setTimeout(function() {
